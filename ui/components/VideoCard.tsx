    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-200 hover:scale-105">
            ...
            >
                ...
                <div className="p-4">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 line-clamp-2">{video.title}</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-2 line-clamp-3">{video.description}</p>
